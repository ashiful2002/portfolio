...
const ProjectDetails = () => {
  ...
  return (
    ...
    <section className="container mx-auto my-12 max-w-7xl scroll-mt-16 px-6 py-24 transition-colors duration-300 dark:bg-gray-900 dark:text-gray-100">
      <h2 className="heading mb-6 dark:text-white">Project Details</h2>

      <div className="flex flex-col gap-10 lg:flex-row">
        {/* Sticky Project Image */}
        <div className="lg:sticky lg:top-24 lg:h-[calc(100vh-6rem)] lg:w-1/2">
          <img
            src={project.img}
            alt={project.title}
            className="sticky max-w-full rounded-lg object-contain shadow-lg dark:shadow-gray-700"
          />
        </div>
